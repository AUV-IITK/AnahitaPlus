...
\begin{DoxyItemize}
\item $\ast$ Some details about the \mbox{\hyperlink{classTest}{Test}} class. $\ast$/ class A\+BC\{\};
\end{DoxyItemize}
...
\end{DoxyItemize}\\
\hline
\mbox{\texttt{ out}}  & {\em dest} & The memory area to copy to.
\begin{DoxyItemize}
\item 
\end{DoxyItemize}\\
\hline
\mbox{\texttt{ in}}  & {\em src} & The memory area to copy from.
\begin{DoxyItemize}
\item 
\end{DoxyItemize}\\
\hline
\mbox{\texttt{ in}}  & {\em n} & The number of bytes to copy $\ast$/ void memcpy(void $\ast$dest, const void $\ast$src, size\+\_\+t n);\\
\hline
\end{DoxyParams}
Link to official documentation of all the commands \href{http://www.doxygen.nl/manual/commands.html}{\texttt{ http\+://www.\+doxygen.\+nl/manual/commands.\+html}} 
